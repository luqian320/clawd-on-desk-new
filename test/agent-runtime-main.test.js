...
describe("agent-runtime-main", () => {
  ...
  it("shows and resolves passive Codex Desktop approval notifications", () => {
    ...
    const monitor = runtime.startCodexLogMonitor();
    const sessionId = localSessionKey("codex:desktop");
    ...
    assert.deepStrictEqual(calls, [
      ["update", sessionId, "notification", "response_item:desktop_approval_requested", {
        cwd: "/repo",
        agentId: "codex",
        sessionTitle: undefined,
        codexOriginator: "Codex Desktop",
      ...
      ["clear", sessionId, "codex-desktop-approval-resolved"],
      ["update", sessionId, "working", "response_item:desktop_approval_resolved", {
        cwd: "/repo",
        agentId: "codex",
        sessionTitle: undefined,
        codexOriginator: "Codex Desktop",
